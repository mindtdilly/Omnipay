---
title: "Configure ProcureNet for Your Environment"
sidebarTitle: "Environment"
description: "Set up your API credentials, choose an EVM payment network, and tune the VCI bridge — everything you need to connect your app to ProcureNet."
---
...
<ParamField body="autoWatch" type="boolean" default="true">
  ...
  `manualConfirmPayment()` explicitly.
</ParamField>
