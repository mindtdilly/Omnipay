---
title: "Get Started with ProcureNet Orchestration API Fast"
...
<Steps>
  ...
  <Step title="Connect to the session stream">
    ...
    <Info>
      Keep your stream connection open for the lifetime of the session. ProcureNet emits state transition events, escrow status updates, and swarm intelligence results over this channel in real time.
    </Info>
  </Step>
